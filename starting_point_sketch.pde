/*--------------------------------------------------------------
        ...
        Detect which serial port the arduino is on
        
        receives list of integers on serial port (comma seperated)
...
// Misc variables
  String sketchTitle = "Starting point sketch - 10Nov20";     // sketch title
 ...
 void serialEvent (Serial ser_port) {
   ...
   if (inString != null) {
     ...
     // extract numbers from the string                
       String[] a = split(inString, ',');           // split comma seperated values in to an array
